    ...
    return (
        <section className={styles.hero}>
            <div className={styles.container}>
                ...
                >
                    <span className={styles.badge}>進路に迷うあなたの専任AIコーチ</span>
                </motion.div>
                ...
                >
                    <p className={styles.description}>
                        誰に相談していいか分からなくても、<br className="mobileBr" />焦らなくていい。<br />
                        AIがあなたの話を受け止め、<br />
                        これから進む道を一緒に探します。<br />
                        <br />
                ...
                >
                    ...
                    <li>今までの人生を振り返って、何がしたいかが見つかる</li>
                ...
                >
                    ...
                    <p className={styles.subCta}>匿名でOK。今の気持ちを<br className={styles.mobileBr} />そのまま打ち込んでください。</p>
                </motion.div>
            </div>
        </section>
    );
